                                   ...
                                   juce::Slider & slider)
{
    ...
    g.setColour( !enabled ? Colour(11u, 1815u, 25u) : Colours::darkslategrey );
    g.fillEllipse(bounds);
    
    g.setColour(enabled ? Colour(70u, 183u, 84u) : Colours::grey);
    g.drawEllipse(bounds, 1.f);
    
    if( auto* rswl = dynamic_cast<RotarySliderLabeled*>(&slider) )
    {
...
void RotarySliderLabeled::paint(juce::Graphics &g)
{
    using namespace juce;
...
juce::Rectangle<int> RotarySliderLabeled::getSliderBounds() const
{
...
juce::String RotarySliderLabeled::getDisplayString() const
{
                                   ...
                                   bool shouldDrawButtonAsDown)
{
    ...
    if( auto* pb = dynamic_cast<PowerButton*>(&toggleButton) )
    {
        ...
        powerButton.addCentredArc(r.getCentreX(), r.getCentreY(), size * 0.5, 0.f, degreesToRadians(ang), degreesToRadians(360 - ang), true);
